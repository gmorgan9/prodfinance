...
<html lang="en">
    ...
    <head>
        ...
        <title>Admin Section - Manage Accounts</title>
    </head>
                        ...
                        <tbody>
                            <?php foreach ($accounts as $key => $account): ?>
                               <tr>
                                    ...
                                    <td><a href="edit.php?id=<?php echo $account['id']; ?>" class="edit">edit</a></td>
                                    <td><a href="index.php?del_id=<?php echo $account['id']; ?>" class="delete">delete</a></td>
                                </tr> 
                            <?php endforeach; ?>
                        </tbody>
                    </table>
