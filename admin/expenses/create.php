            ...
            <div class="admin-content">
                ...
                <div class="content">
                    ...
                    <form action="create.php" method="post">
                        ...
                        <div>
                            <label>Amount</label>
                            <input type="number" name="amount" value="" class="text-input">
                        </div>
                        <div>
                            <label>Category</label>
                            <input type="text" name="cateogry" value="" class="text-input">
                        </div>
                        <div>
                            <label>Account</label>
                            <input type="text" name="account" value="" class="text-input">
                        </div>
                        <div>
                            <label>Date</label>
                            <input type="date" name="date" value="" class="text-input">
                        </div>
                        <div>
